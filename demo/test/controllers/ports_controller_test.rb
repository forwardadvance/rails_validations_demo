...
class PortsControllerTest < ActionController::TestCase
  ...
  test "should create port" do
    assert_difference('Port.count') do
      post :create, port: { description: @port.description, lat: @port.lat, lng: @port.lng, name: @port.name, weather: @port.weather }
    end
  ...
  test "should update port" do
    patch :update, id: @port, port: { description: @port.description, lat: @port.lat, lng: @port.lng, name: @port.name, weather: @port.weather }
    assert_redirected_to port_path(assigns(:port))
  end
